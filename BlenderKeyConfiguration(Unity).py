...
kmi = km.keymap_items.new('view3d.cursor3d', 'RIGHTMOUSE', 'PRESS', shift=True, oskey=True)
...
kmi = km.keymap_items.new('Zoom View', 'LEFTMOUSE', 'PRESS', alt=True)
kmi = km.keymap_items.new('view3d.move', 'RIGHTMOUSE', 'PRESS', alt=True)
